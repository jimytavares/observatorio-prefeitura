        ...
        <div class="row">
            <div class="col-md-6">
                <div class="image-showcase">
                    <img src="{{ asset('images/garantia-direito-idosos.png') }}" alt="Pessoas Idosas" class="img-fluid">
                </div>
            </div>
            <div class="col-md-6 mt-4">
                <div class="info-card text-justify" style="height: 382px;">
                    <h4><i class="fas fa-info-circle"></i> Informação</h4>
                    <p>A garantia de direitos para pessoas idosas abrange as políticas públicas serviços e iniciativas que promovem a proteção, o envelhecimento ativo e a participação social, assegurando o respeito à sua dignidade e autonomia, e fortalecendo o acesso a condições dignas de vida, saúde, convivência familiar e comunitária, entre outros direitos.</p>
                </div>
            </div>
        </div>
    </div>
