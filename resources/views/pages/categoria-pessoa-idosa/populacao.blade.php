        ...
        <div class="row">
            <div class="col-md-6">
                <div class="image-showcase">
                    <img src="{{ asset('images/idosos-populacao.png') }}" alt="População Idosa" class="img-fluid">
                </div>
            </div>
            <div class="col-md-6 mt-4">
                <div class="info-card text-justify" style="height: 382px;">
                    <h4><i class="fas fa-info-circle"></i> Informação</h4>
                    <p>O conceito de pessoa idosa no Brasil, com base legal, é definido pelo Estatuto da Pessoa Idosa (Lei nº 10.741, de 1º de outubro de 2003). </p> </br>
                    <p>De acordo com o Artigo 1º desta lei, o Estatuto destinado a regular os direitos assegurados às pessoas com idade igual ou superior a 60 (sessenta) anos.</p>
                </div>
            </div>
        </div>
    </div>
