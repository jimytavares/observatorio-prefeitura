        ...
        <div class="row">
            <div class="col-md-6">
                <div class="image-showcase">
                    <img src="{{ asset('images/lgbt-garantia.jpg') }}" alt="População em situação de rua" class="img-fluid">
                </div>
            </div>
            <div class="col-md-6 mt-4">
                <div class="info-card text-justify" style="height: 382px;">
                    <h4><i class="fas fa-info-circle"></i> Informação</h4>
                    <p>A garantia de direitos para pessoas LGBTQIAPN+ envolve medidas que promovam a inclusão social, o respeito à diversidade, a proteção contra a violência e a discriminação, e o acesso a políticas públicas que atendam às suas necessidades específicas (como saúde, educação, moradia e segurança), assegurando a dignidade e a autonomia, e a eliminação das barreiras que impedem sua plena participação na sociedade.</p>
                </div>
            </div>
        </div>
    </div>
