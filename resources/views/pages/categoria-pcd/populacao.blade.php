        ...
        <div class="row">
            <div class="col-md-6">
                <div class="image-showcase">
                    <img src="{{ asset('images/populacao-pcd.jpg') }}" alt="População pcd" class="img-fluid">
                </div>
            </div>
            <div class="col-md-6 mt-4">
                <div class="info-card text-justify" style="height: 382px;">
                    <h4><i class="fas fa-info-circle"></i> Informação</h4>
                    <p>O conceito de pessoa com deficiência abrange aquela que tem impedimento de longo prazo de natureza física, mental, intelectual ou sensorial, o qual, em interação com uma ou mais barreiras, pode obstruir sua participação plena e efetiva na sociedade em igualdade de condições com as demais pessoas.</p> </br>
                    <p>De acordo com dados de 2025 do IBGE, a população de pessoas com deficiência no Município de Natal é de 64.300 pessoas, representando 8% da população da cidade. 59,3% das pessoas com deficiência em Natal é do sexo masculino e 40,7% do sexo feminino.</p>
                </div>
            </div>
        </div>
    </div>
