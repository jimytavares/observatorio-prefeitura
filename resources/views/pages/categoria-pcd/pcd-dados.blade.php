...
@section('title', 'Painel de Dados - Pessoas Idosas')
            ...
            <nav class="breadcrumb-nav">
                <div class="container">
                    <ol class="breadcrumb breadcrumb-custom">
                        ...
                        <li class="breadcrumb-item"><a href="#">PCD</a></li>
                        <li class="breadcrumb-item active">Dados sobre PCD</li>
                    </ol>
                </div>
            </nav>
        </div>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="image-showcase">
                    <img src="{{ asset('images/pessoas-deficiencias.jpeg') }}" alt="População em situação de rua" class="img-fluid">
                </div>
            </div>
            <div class="col-md-6">
                <div class="info-card">
                    ...
                    <p>
                        Os dados apresentados são baseados no IBGE e no Cadastro Único para Programas Sociais do Governo Federal, que registram informações sobre pessoas com deficiência no Brasil. É importante ressaltar que estes números podem representar uma subestimação da realidade, devido às dificuldades inerentes ao mapeamento e identificação desta população.
                    </p>
                    </p>
                </div>
            </div>
...
<section class="content-section" style="margin-top: -90px;">
    <div class="container">
        <h2 class="section-title">Dados e Análises Completos</h2>
            ...
            <!-- ## Seção 1: População PCD por Faixa Etária IBGE -->
            <div class="content-block">
                <div class="row align-items-center mb-5">
                    <div class="col-lg-6">
                        <div class="chart-container">
                            <h4 class="chart-title">População PCD por Faixa Etária (IBGE)</h4>
                    ...
                    <div class="col-lg-6">
                        <div class="content-text">
                            <h3 class="content-title">
                                ...
                                População PCD - Dados IBGE por Faixa Etária
                            </h3>
                            <p style="width:90%; margin-left:20px;">Os dados do IBGE apresentados no gráfico mostram a distribuição da população de pessoas com deficiência (PCD) em diferentes faixas etárias. A faixa de 20 a 59 anos concentra o maior número de pessoas com deficiência, totalizando <strong>30.685</strong> indivíduos, sendo <strong>17.797</strong> do sexo feminino e <strong>12.888</strong> do sexo masculino.</p>
                            <p style="width:90%; margin-left:20px;">Na faixa de pessoas idosas (> 60 anos), são <strong>28.320</strong> pessoas com deficiência, com predominância feminina de <strong>18.298</strong> mulheres e <strong>10.022</strong> homens. Nas faixas mais jovens, temos <strong>2.034</strong> pessoas entre 13-19 anos e <strong>1.610</strong> entre 0-12 anos. Estes dados são essenciais para o planejamento de políticas públicas de inclusão e acessibilidade.</p>
                            <div class="">
                                <span class="badge badge-info">Total: 62.649</span>
                                <span class="badge badge-warning">Adultos: 48,9%</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <!-- ## Seção 2: Denúncias Recebidas - PCD -->
            <div class="content-block">
                <div class="row align-items-center mb-5">
                    <div class="col-lg-6">
                        <div class="content-text">
                            <h3 class="content-title">
                                ...
                                Denúncias Recebidas - Pessoas com Deficiência
                            </h3>
                            <p style="width:90%; margin-left:20px;">Os dados apresentados no gráfico mostram as denúncias recebidas relacionadas a pessoas com deficiência, organizadas por diferentes faixas etárias e características demográficas. O total de <strong>573</strong> denúncias evidencia a vulnerabilidade desta população a diversas formas de violência e violação de direitos.</p>
                            <p style="width:90%; margin-left:20px;">Na análise por gênero, observamos <strong>312</strong> denúncias envolvendo mulheres com deficiência (54,4%) e <strong>263</strong> envolvendo homens (45,9%). Por raça/cor, há <strong>238</strong> denúncias de pessoas brancas, <strong>251</strong> de pessoas pretas/pardas e <strong>16</strong> de outras categorias. Estes dados são fundamentais para o desenvolvimento de políticas de proteção específicas para pessoas com deficiência.</p>
                            <div class="">
                                <span class="badge badge-info">Total: 573 denúncias</span>
                                <span class="badge badge-warning">Feminino: 54,4%</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="chart-container">
                            <h4 class="chart-title">Denúncias Recebidas - PCD por Faixa Etária</h4>
                            <div id="apexchart-denuncias-pcd"></div>
                            <script>
                            document.addEventListener('DOMContentLoaded', function () {
                                var options = {
                                    chart: {
                                    ...
                                    yaxis: {
                                        title: { text: 'Número de Denúncias' }
                                    },
                                    ...
                                    tooltip: {
                                        y: {
                                            formatter: function (val) {
                                                return val.toLocaleString('pt-BR') + ' denúncias';
                                            }
                                        }
                                    }
                                };
                                var chart = new ApexCharts(document.querySelector("#apexchart-denuncias-pcd"), options);
                                chart.render();
                            });
                            </script>
                        </div>
