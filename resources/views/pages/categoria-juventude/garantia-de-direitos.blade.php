        ...
        <div class="row">
            <div class="col-md-6">
                <div class="image-showcase">
                    <img src="{{ asset('images/juventude-garantia.jpg') }}" alt="População em situação de rua" class="img-fluid">
                </div>
            </div>
            <div class="col-md-6 mt-4">
                <div class="info-card text-justify">
                    <h4><i class="fas fa-info-circle"></i> Informação</h4>
                    <p>A garantia de direitos da população jovem envolve a implementação de políticas públicas voltadas à promoção da educação, da empregabilidade, da saúde, da cultura, do esporte, da segurança e da participação social e política. Destacam-se, nesse contexto, as iniciativas de ampliação do acesso e permanência na educação básica e superior, os programas de qualificação profissional e de incentivo ao primeiro emprego, as políticas de saúde voltadas às necessidades específicas da juventude, com atenção à saúde mental, sexual e reprodutiva, bem como as ações que promovem o acesso a bens culturais, ao esporte e ao lazer. Da mesma forma, políticas de enfrentamento à violência e à discriminação, com atenção especial à juventude negra, periférica e LGBTQIAPN+, são fundamentais para a redução das desigualdades.</p>
                </div>
            </div>
        </div>
    </div>
