        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="data-card">
                    ...
                    <p class="card-description">As mulheres representam a maioria da população do Município de Natal. De acordo com o Censo Demográfico 2022 (IBGE), o município possui...</p>
                    <div class="text-center">
                        <a href="{{ route('populacao_mulher') }}" class="card-link">Ver Dados</a>
                    </div>
                </div>
            </div>
            <!-- Card 2 -->
            <div class="col-lg-4 col-md-6">
                <div class="data-card">
                    ...
                    <p class="card-description">As violações de direitos das mulheres configuram-se em ações ou omissões que comprometem a dignidade, a autonomia, a igualdade ...</p>
                    <div class="text-center">
                         <a href="{{ route('violacao-de-direito-mulher') }}" class="card-link">Ver Dados</a>
                    </div>
                </div>
            </div>
            <!-- Card 3 -->
            <div class="col-lg-4 col-md-6">
                <div class="data-card">
                    ...
                    <p class="card-description">A garantia de direitos das mulheres compreende o conjunto de políticas públicas, serviços especializados e ações afirmativas voltadas para a promoção da...</p>
                    <div class="text-center">
                        <a href="{{ route('garantia-de-direito-mulher') }}" class="card-link">Ver Dados</a>
                    </div>
                </div>
            </div>
