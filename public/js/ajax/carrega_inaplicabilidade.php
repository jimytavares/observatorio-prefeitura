...
$sql="SELECT * FROM tb_licitacontra WHERE (tipo = 'inaplicidade' AND YEAR(datta) = '".$q."') ORDER BY datta DESC, id DESC";
...
echo '<div class="row">';
        ...
        echo '<div class="col-6">';
            ...
            echo '<form>';
              echo '<select class="form-control" id="exampleFormControlSelect1" name="" onchange="selectInaplicabilidade(this.value)" style="color:#595959; border-radius:3px; border: 1px solid gray; height:38px;">';
